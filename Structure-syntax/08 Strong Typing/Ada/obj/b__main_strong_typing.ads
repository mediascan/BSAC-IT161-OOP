...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_main_strong_typing" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#dc89fb2b#;
   pragma Export (C, u00001, "main_strong_typingB");
